...
<%@ page import="service.BookSpService" %>
<head>
    <title>场馆预约</title>
    <!-- MetisMenu CSS -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            %>
                            <%
                                ArrayList<BookSpBean> job1= (ArrayList<BookSpBean>) request.getAttribute("list1");
                                if(job1!=null){
                                    System.out.println("!!!");}
                            %>
                            <%
                                System.out.print(job1.size());
                                for(int i=0;i<job1.size();i++){
                                    BookSpBean psb=(BookSpBean)job1.get(i);
                                    if(psb!=null){
                                        System.out.println(psb.getIdplace());}
                                    else
                                        System.out.println("null!!!!");%>
                            <tr class="odd gradeX">
                                <th><%=psb.getIdplace() %> <%=psb.getIdroom()%></th>
                                <th><%=psb.getTime()%></th>
                                <th><%=psb.getVacancy()%></th>
                                <th><%=psb.getMax()%></th>
                                <th>OK</th>
                            </tr>
                            <% }
                            %>
                            <%
                                ArrayList<BookHiBean> job2= (ArrayList<BookHiBean>) request.getAttribute("list2");
                                if(job2!=null){
                                    System.out.println("!!!");}
                            %>
                            <%
                                System.out.print(job2.size());
                                for(int i=0;i<job2.size();i++){
                                    BookHiBean psb=(BookHiBean)job2.get(i);
                                    if(psb!=null){
                                        System.out.println(psb.getIdplace());}
                                    else
                                        System.out.println("null!!!!");%>
                            <tr class="odd gradeX">
                                <th><%=psb.getIdplace() %></th>
                                <th><%=psb.getTime()%></th>
                                <th><%=psb.getVacancy()%></th>
                                <th><%=psb.getMax()%></th>
                                <th>OK</th>
                            ...
                            %>
                            <%
                                ArrayList<BookEdBean> job3= (ArrayList<BookEdBean>) request.getAttribute("list3");
                                if(job3!=null){
                                    System.out.println("!!!");}
                            %>
                            <%
                                System.out.print(job3.size());
                                for(int i=0;i<job3.size();i++){
                                    BookEdBean psb=(BookEdBean)job3.get(i);
                                    if(psb!=null){
                                        System.out.println(psb.getIdplace());}
                                    else
                                        System.out.println("null!!!!");%>
